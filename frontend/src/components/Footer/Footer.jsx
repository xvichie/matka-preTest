...
function Footer() {
  ...
  const addVisitorCounter = () => {
    ...
    // Find the topge-container div
    const topgeContainer = document.querySelector('.topge-container');

    // Append the div to the topge-container
    topgeContainer.appendChild(div);
    ...
    return () => {
      topgeContainer.removeChild(div);
