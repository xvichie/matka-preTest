...
export default function AnswerSheetModalComponent({  ButtonIcon, currentTest }) {
    ...
    const testId = useSelector((state) => state.userTests.tests[currentTest]._id);
    //console.log(test);
    useEffect(() => {
        const newRows = [];
        const newImageRows = [];
    ...
    return (
        <div className='AnswerSheet-Button'>
            ...
            >
                <Fade in={open}>
                    <Box sx={style} className='AnswerSheet-Box'>
                            ...
                            <div className="TopStats-Stats">
                                <TableContainer component={Paper}>
                                    <Table>
                                        ...
                                        <TableBody>
                                            <TableRow>
                                                <TableCell align="center">{currentTest+1}</TableCell>
